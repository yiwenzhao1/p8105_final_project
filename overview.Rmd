...
<p align="center">
![pic.](/Users/yitian/Desktop/p8105_final_project/外源图片/Gotham_City.jpg){width=100% height=60%}  </p>
<p align=" center", p style="font-family: times, serif; font-size:11pt; font-style:italic">
Photo retrived from [DC Extended Universe Wiki](https://dcextendeduniverse.fandom.com/wiki/Gotham_City)
</p>
...
<p align="center">
![pic1.](/Users/yitian/Desktop/p8105_final_project/外源图片/Untitled-collage-41.jpg){width=60% height=60%}  </p>
<p align=" center", p style="font-family: times, serif; font-size:11pt; font-style:italic">
...
First we eliminated some variables that we were not interested in. Then, since each year's criminal records are contained in a separate dataset respectively, we created a tidy dataframe containing all criminal records from 2016 to 2021. Also, since our analysis will include some predictions for trend, we split variable "data" and composed new variables as "year","month", and "day" respectively to facilitate our analysis of trends for each year. Here is our data process:
...
The part of resulting data `data_clean` used for analysis can be viewed below.

```{r echo=FALSE}
show_data = read.csv("./Data/data_clean.csv")
datatable(head(show_data,20), rownames = FALSE, filter = "top", 
